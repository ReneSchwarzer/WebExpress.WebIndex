...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageReverseIndexB : UnitTestIndexStorage<UnitTestIndexFixtureIndexB>
    {
        /// <summary>
        /// Test class for testing the storage-based reverse index.
        /// </summary>
        protected PropertyInfo Property => typeof(UnitTestIndexTestDocumentB).GetProperty("Name");
        ...
        public UnitTestIndexStorageReverseIndexB(UnitTestIndexFixtureIndexB fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Create()
        {
            ...
            // test execution
            var reverseIndex = new IndexMemoryReverse<UnitTestIndexTestDocumentB>(IndexManager.Context, Property, CultureInfo.GetCultureInfo("en"));
        ...
        public void UpdateWithChange()
        {
            ...
            // test execution
            var newItem = new UnitTestIndexTestDocumentB()
            {
                Id = randomItem.Id,
