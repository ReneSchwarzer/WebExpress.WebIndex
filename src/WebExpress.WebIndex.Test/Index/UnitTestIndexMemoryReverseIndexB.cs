...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexMemoryReverseIndexB : UnitTestIndexMemory<UnitTestIndexFixtureIndexB>
    {
        /// <summary>
        ...
        public UnitTestIndexMemoryReverseIndexB(UnitTestIndexFixtureIndexB fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
