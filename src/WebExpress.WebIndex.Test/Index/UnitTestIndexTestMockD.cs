...
{
    public class UnitTestIndexTestMockD : UnitTestIndexTestDocument
    {
        ...
        public static List<UnitTestIndexTestMockD> GenerateTestData()
        {
            int id = 0;
            var testDataList = new List<UnitTestIndexTestMockD>
            {
                new ()
                {
                    Id = Guid.NewGuid(),
