...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexMemoryReverseIndexC : UnitTestIndexMemory<UnitTestIndexFixtureIndexC>
    {
        /// <summary>
        ...
        public UnitTestIndexMemoryReverseIndexC(UnitTestIndexFixtureIndexC fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
