...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageReverseIndexA : UnitTestIndexStorage<UnitTestIndexFixtureIndexA>
    {
        /// <summary>
        ...
        public UnitTestIndexStorageReverseIndexA(UnitTestIndexFixtureIndexA fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
