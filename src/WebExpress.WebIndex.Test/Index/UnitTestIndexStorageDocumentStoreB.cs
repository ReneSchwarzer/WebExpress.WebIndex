...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageDocumentStoreB : UnitTestIndexStorage<UnitTestIndexFixtureIndexB>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexStorageDocumentStoreB(UnitTestIndexFixtureIndexB fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Add()
        {
            // preconditions
            Preconditions();
            var documentStore = new IndexMemoryDocumentStore<UnitTestIndexTestDocumentB>(IndexManager.Context, (uint)Fixture.TestData.Count);
