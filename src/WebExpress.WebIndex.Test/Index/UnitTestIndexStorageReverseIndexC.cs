...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageReverseIndexC : UnitTestIndexStorage<UnitTestIndexFixtureIndexC>
    {
        /// <summary>
        /// Test class for testing the storage-based reverse index.
        /// </summary>
        protected PropertyInfo Property => typeof(UnitTestIndexTestDocumentC).GetProperty("Text");
        ...
        public UnitTestIndexStorageReverseIndexC(UnitTestIndexFixtureIndexC fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Create()
        {
            ...
            // test execution
            var reverseIndex = new IndexMemoryReverse<UnitTestIndexTestDocumentC>(IndexManager.Context, Property, CultureInfo.GetCultureInfo("en"));
        ...
        public void UpdateWithChange()
        {
            ...
            // test execution
            var newItem = new UnitTestIndexTestDocumentC()
            {
                Id = randomItem.Id,
        ...
        public void Remove()
        {
            ...
            var before = reverseIndex.Collect(randomItem.Text).ToList();
            Assert.True(before.Any());

            // test execution
            reverseIndex.Remove(randomItem);

            var after = reverseIndex.Collect(randomItem.Text).ToList();
        ...
        public void Retrieve()
        {
            ...
            // test execution
            var items = reverseIndex.Collect(randomItem.Text);
