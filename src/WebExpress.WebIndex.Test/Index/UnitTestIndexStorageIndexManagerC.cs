...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageIndexManagerC : UnitTestIndexStorage<UnitTestIndexFixtureIndexC>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexStorageIndexManagerC(UnitTestIndexFixtureIndexC fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Update()
        {
            ...
            var wql = IndexManager.ExecuteWql<UnitTestIndexTestDocumentC>("name = 'Aurora'");
            var item = wql.Apply();
