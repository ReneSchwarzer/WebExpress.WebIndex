...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageIndexManagerA : UnitTestIndexStorage<UnitTestIndexFixtureIndexA>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexStorageIndexManagerA(UnitTestIndexFixtureIndexA fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Update()
        {
            ...
            var wql = IndexManager.ExecuteWql<UnitTestIndexTestDocumentA>("name = 'Aurora'");
            var item = wql.Apply();
