...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageIndexManagerB : UnitTestIndexStorage<UnitTestIndexFixtureIndexB>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexStorageIndexManagerB(UnitTestIndexFixtureIndexB fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
