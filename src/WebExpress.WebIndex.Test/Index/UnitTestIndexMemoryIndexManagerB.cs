...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexMemoryIndexManagerB : UnitTestIndexMemory<UnitTestIndexFixtureIndexB>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexMemoryIndexManagerB(UnitTestIndexFixtureIndexB fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
