...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexMemoryReverseIndexE : UnitTestIndexMemory<UnitTestIndexFixtureIndexE>
    {
        /// <summary>
        ...
        public UnitTestIndexMemoryReverseIndexE(UnitTestIndexFixtureIndexE fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
