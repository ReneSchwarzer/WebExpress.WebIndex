...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageDocumentStoreD : UnitTestIndexStorage<UnitTestIndexFixtureIndexD>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexStorageDocumentStoreD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Add()
        {
            // preconditions
            Preconditions();
            var documentStore = new IndexMemoryDocumentStore<UnitTestIndexTestDocumentD>(IndexManager.Context, (uint)Fixture.TestData.Count);
