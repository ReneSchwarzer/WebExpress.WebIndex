...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexMemoryDocumentStoreE : UnitTestIndexMemory<UnitTestIndexFixtureIndexE>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexMemoryDocumentStoreE(UnitTestIndexFixtureIndexE fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
