...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexMemoryReverseIndexD : UnitTestIndexMemory<UnitTestIndexFixtureIndexD>
    {
        /// <summary>
        ...
        public UnitTestIndexMemoryReverseIndexD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
