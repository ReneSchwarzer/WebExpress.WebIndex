...
namespace WebExpress.WebIndex.Test.Index
{
    ...
    /// </summary>
    public class UnitTestIndexStorageIndexManagerD : UnitTestIndexStorage<UnitTestIndexFixtureIndexD>
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UnitTestIndexStorageIndexManagerD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
