    ...
    public class UnitTestIndexTestDocumentFactoryA : UnitTestIndexTestDocumentFactory
    {
        ...
        public static List<UnitTestIndexTestDocumentA> GenerateTestData()
        {
            var testDataList = new[]
            {
                ...
                new UnitTestIndexTestDocumentA { Id = new Guid("c7d8f9e0-3a2b-4c5d-8e6f-9a1b0c2d4e5f"), Text = "Hello Helena and Helge!"},
                ...
                new UnitTestIndexTestDocumentA { Id = new Guid("614aac74-13d1-414b-a163-cccce949b3cb"), Text = "Hi Dave, Charlie, and Bob!"}
            };
