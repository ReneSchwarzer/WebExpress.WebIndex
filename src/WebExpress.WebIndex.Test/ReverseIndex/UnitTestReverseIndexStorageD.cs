...
namespace WebExpress.WebIndex.Test.ReverseIndex
{
    ...
    /// </summary>
    public class UnitTestReverseIndexStorageD : UnitTestReverseIndex<UnitTestIndexFixtureIndexD>
    {
        /// <summary>
        /// Test class for testing the storage-based reverse index.
        /// </summary>
        ...
        public UnitTestReverseIndexStorageD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Create()
        {
            ...
            // test execution
            var reverseIndex = new IndexMemoryReverse<UnitTestIndexTestDocumentD>(Context, Property, CultureInfo.GetCultureInfo("en"));
