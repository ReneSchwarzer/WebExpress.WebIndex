...
namespace WebExpress.WebIndex.Test.ReverseIndex
{
    ...
    public class UnitTestReverseIndexStorageD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output) : UnitTestReverseIndex<UnitTestIndexFixtureIndexD>(fixture, output)
    {
        ...
        /// Test class for testing the storage-based reverse index.
        /// </summary>
        protected static PropertyInfo Property => typeof(UnitTestIndexTestDocumentD).GetProperty("FirstName");
        ...
        public void Create()
        {
            ...
            // test execution
            var reverseIndex = new IndexStorageReverseTerm<UnitTestIndexTestDocumentD>(Context, Property, CultureInfo.GetCultureInfo("en"));
