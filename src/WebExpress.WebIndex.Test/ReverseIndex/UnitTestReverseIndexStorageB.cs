...
namespace WebExpress.WebIndex.Test.ReverseIndex
{
    ...
    /// </summary>
    public class UnitTestReverseIndexStorageB : UnitTestReverseIndex<UnitTestIndexFixtureIndexB>
    {
        /// <summary>
        /// Test class for testing the storage-based reverse index.
        /// </summary>
        ...
        public UnitTestReverseIndexStorageB(UnitTestIndexFixtureIndexB fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
