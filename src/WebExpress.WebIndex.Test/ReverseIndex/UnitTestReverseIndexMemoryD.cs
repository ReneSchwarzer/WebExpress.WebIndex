...
namespace WebExpress.WebIndex.Test.ReverseIndex
{
    ...
    /// </summary>
    public class UnitTestReverseIndexMemoryD : UnitTestReverseIndex<UnitTestIndexFixtureIndexD>
    {
        /// <summary>
        ...
        public UnitTestReverseIndexMemoryD(UnitTestIndexFixtureIndexD fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
