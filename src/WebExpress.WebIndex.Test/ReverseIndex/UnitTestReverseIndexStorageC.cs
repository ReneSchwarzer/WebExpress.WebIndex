...
namespace WebExpress.WebIndex.Test.ReverseIndex
{
    ...
    /// </summary>
    public class UnitTestReverseIndexStorageC : UnitTestReverseIndex<UnitTestIndexFixtureIndexC>
    {
        /// <summary>
        /// Test class for testing the storage-based reverse index.
        /// </summary>
        ...
        public UnitTestReverseIndexStorageC(UnitTestIndexFixtureIndexC fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
        ...
        public void Create()
        {
            ...
            // test execution
            var reverseIndex = new IndexMemoryReverse<UnitTestIndexTestDocumentC>(Context, Property, CultureInfo.GetCultureInfo("en"));
