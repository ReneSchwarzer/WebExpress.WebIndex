...
namespace WebExpress.WebIndex.Test.ReverseIndex
{
    ...
    /// </summary>
    public class UnitTestReverseIndexMemoryE : UnitTestReverseIndex<UnitTestIndexFixtureIndexE>
    {
        /// <summary>
        ...
        public UnitTestReverseIndexMemoryE(UnitTestIndexFixtureIndexE fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
