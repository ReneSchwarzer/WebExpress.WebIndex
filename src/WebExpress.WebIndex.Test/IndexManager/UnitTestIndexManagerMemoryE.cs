...
namespace WebExpress.WebIndex.Test.IndexManager
{
    ...
    public class UnitTestIndexManagerMemoryE : UnitTestIndexManager<UnitTestIndexFixtureIndexE>
    {
        ...
        public void ReIndex_En()
        {
            ...
            var wql = IndexManager.Select<UnitTestIndexTestDocumentE>($"name = '{randomItem.Name}'");
            Assert.NotNull(wql);
        ...
        public void ReIndex_De()
        {
            ...
            Preconditions();
            var randomItem = Fixture.RandomItem;
            IndexManager.Create<UnitTestIndexTestDocumentE>(CultureInfo.GetCultureInfo("de"), IndexType.Memory);
        ...
        public void ReIndex_DeDE()
        {
            ...
            Preconditions();
            var randomItem = Fixture.RandomItem;
            IndexManager.Create<UnitTestIndexTestDocumentE>(CultureInfo.GetCultureInfo("de-DE"), IndexType.Memory);
        ...
        public void ReIndex_Fr()
        {
            ...
            Preconditions();
            var randomItem = Fixture.RandomItem;
            IndexManager.Create<UnitTestIndexTestDocumentE>(CultureInfo.GetCultureInfo("fr"), IndexType.Memory);
        ...
        public void Delete()
        {
            ...
            wql = IndexManager.Select<UnitTestIndexTestDocumentE>($"name = '{randomItem.Name}'");
            Assert.NotNull(wql);
        ...
        public void Add()
        {
            ...
            var wql = IndexManager.Select<UnitTestIndexTestDocumentE>("name = 'Aurora'");
            var item = wql.Apply();
