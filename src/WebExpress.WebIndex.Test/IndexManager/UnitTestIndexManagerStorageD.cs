...
namespace WebExpress.WebIndex.Test.IndexManager
{
    ...
    public class UnitTestIndexManagerStorageD : UnitTestIndexManager<UnitTestIndexFixtureIndexD>
    {
        ...
        public void ReIndex_De()
        {
            ...
            Preconditions();
            var randomItem = Fixture.RandomItem;
            IndexManager.Register<UnitTestIndexTestDocumentD>(CultureInfo.GetCultureInfo("de"), IndexType.Storage);
        ...
        public void ReIndex_DeDE()
        {
            ...
            Preconditions();
            var randomItem = Fixture.RandomItem;
            IndexManager.Register<UnitTestIndexTestDocumentD>(CultureInfo.GetCultureInfo("de-DE"), IndexType.Storage);
        ...
        public void ReIndex_Fr()
        {
            ...
            Preconditions();
            var randomItem = Fixture.RandomItem;
            IndexManager.Register<UnitTestIndexTestDocumentD>(CultureInfo.GetCultureInfo("fr"), IndexType.Storage);
