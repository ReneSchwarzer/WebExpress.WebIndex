...
namespace WebExpress.WebIndex.Test.IndexManager
{
    ...
    public class UnitTestIndexManagerStorageA : UnitTestIndexManager<UnitTestIndexFixtureIndexA>
    {
        ...
        public void ReIndex_En()
        {
            ...
            var wql = IndexManager.Select<UnitTestIndexTestDocumentA>("name = 'Helena'");
            Assert.NotNull(wql);
        ...
        public async void ReIndexAsync_En()
        {
            ...
            var wql = IndexManager.Select<UnitTestIndexTestDocumentA>($"text = '{randomItem.Text}'");
            Assert.NotNull(wql);
        ...
        public void Delete()
        {
            ...
            wql = IndexManager.Select<UnitTestIndexTestDocumentA>("name = 'Helena'");
            Assert.NotNull(wql);
