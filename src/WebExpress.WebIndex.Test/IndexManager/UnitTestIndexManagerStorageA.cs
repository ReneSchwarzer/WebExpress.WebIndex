...
namespace WebExpress.WebIndex.Test.IndexManager
{
    ...
    public class UnitTestIndexManagerStorageA : UnitTestIndexManager<UnitTestIndexFixtureIndexA>
    {
        ...
        public void ReIndex_En()
        {
            ...
            var wql = IndexManager.Retrieve<UnitTestIndexTestDocumentA>("name = 'Helena'");
            Assert.NotNull(wql);
        ...
        public async void ReIndexAsync_En()
        {
            ...
            var wql = IndexManager.Retrieve<UnitTestIndexTestDocumentA>($"text = '{randomItem.Text}'");
            Assert.NotNull(wql);
        ...
        public void Delete()
        {
            ...
            wql = IndexManager.Retrieve<UnitTestIndexTestDocumentA>("name = 'Helena'");
            Assert.NotNull(wql);
