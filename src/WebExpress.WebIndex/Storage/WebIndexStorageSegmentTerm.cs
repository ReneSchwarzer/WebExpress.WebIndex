...
{
    public class WebIndexStorageSegmentTerm : WebIndexStorageSegment, IWebIndexStorageSegmentListItem
    {
        /// <summary>
        ...
        /// </summary>
        public WebIndexStorageSegmentHashMap<WebIndexStorageSegmentPosting> Postings { get; private set; }

        /// <summary>
        /// Returns the amount of space required on the storage device.
        /// </summary>
        public override uint Size => sizeof(ulong) + sizeof(uint) + sizeof(uint) + Length + Postings.Size;

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="context">The reference to the context of the index.</param>
        public WebIndexStorageSegmentTerm(WebIndexStorageContext context)
            : base(context)
        {
            Postings = new WebIndexStorageSegmentHashMap<WebIndexStorageSegmentPosting>(Context, 10);
        }
        ...
        {
            if (obj is WebIndexStorageSegmentTerm term)
            {
