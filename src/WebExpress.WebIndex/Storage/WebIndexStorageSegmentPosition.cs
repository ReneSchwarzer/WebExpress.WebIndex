...
{
    public class WebIndexStorageSegmentPosition : WebIndexStorageSegment, IWebIndexStorageSegmentListItem
    {
        /// <summary>
        ...
        public WebIndexStorageSegmentPosition(WebIndexStorageContext context)
            : base(context)
        {
        }
        ...
        {
            if (obj is WebIndexStorageSegmentPosition position)
            {
