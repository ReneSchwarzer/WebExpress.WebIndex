...
{
    public abstract class WebIndexStorageSegment : IWebIndexStorageSegment
    {
        /// <summary>
        ...
        /// </summary>
        public WebIndexStorageContext Context { get; private set; }
        ...
        public WebIndexStorageSegment(WebIndexStorageContext context)
        {
            Context = context;
        }
