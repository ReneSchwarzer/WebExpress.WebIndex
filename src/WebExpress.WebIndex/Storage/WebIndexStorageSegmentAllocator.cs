...
namespace WebExpress.WebIndex.Storage
{
    ...
    /// </summary>
    public class WebIndexStorageSegmentAllocator : WebIndexStorageSegment
    {
        /// <summary>
        ...
        public WebIndexStorageSegmentAllocator(WebIndexStorageContext context)
            : base(context)
        {
            Addr = WebIndexStorageSegmentHeader.SegmentSize;
        ...
        public ulong Alloc(IWebIndexStorageSegment segment)
        {
            if (segment.Addr != 0)
            {
        ...
        /// </summary>
        /// <param name="segment">The segment determines how much memory should be reserved.</param>
        public void Free(IWebIndexStorageSegment segment)
        {
