...
{
    public class WebIndexStorageSegmentItem : WebIndexStorageSegment, IWebIndexStorageSegmentListItem
    {
        /// <summary>
        ...
        public WebIndexStorageSegmentItem(WebIndexStorageContext context)
            : base(context)
        {
        }
        ...
        {
            if (obj is WebIndexStorageSegmentItem item)
            {
