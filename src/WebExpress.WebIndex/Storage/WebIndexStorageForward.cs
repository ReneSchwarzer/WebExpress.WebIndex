...
namespace WebExpress.WebIndex.Storage
{
    ...
    public class WebIndexStorageForward<T> : IWebIndexForward<T>, IWebIndexStorage where T : IWebIndexItem
    {
        /// <summary>
        ...
        /// </summary>
        public WebIndexStorageSegmentHashMap<WebIndexStorageSegmentItem> HashMap { get; private set; }
        ...
        public WebIndexStorageForward(IWebIndexContext context, uint capacity)
        {
            Context = context;
            Capacity = capacity;
            ...
            Header = new WebIndexStorageSegmentHeader(new WebIndexStorageContext(this)) { Identifier = "wfi" };
            ...
            HashMap = new WebIndexStorageSegmentHashMap<WebIndexStorageSegmentItem>(new WebIndexStorageContext(this), Capacity);
        ...
        public void Add(T item)
        {
            ...
            var segment = new WebIndexStorageSegmentItem(new WebIndexStorageContext(this))
            {
                Id = item.Id,
                Data = bytes
            };
        ...
        /// <returns>The item.</returns>
        private static T GetItem(WebIndexStorageSegmentItem segment)
        {
