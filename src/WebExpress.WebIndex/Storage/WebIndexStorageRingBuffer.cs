...
namespace WebExpress.WebIndex.Storage
{
    ...
    /// </summary>
    public class WebIndexStorageRingBuffer
    {
        /// <summary>
        /// The ring buffer.
        /// </summary>
        private IWebIndexStorageSegment[] buffer;

        /// <summary>
        /// Buffer for random access.
        /// </summary>
        private Dictionary<ulong, IWebIndexStorageSegment> dict;
        ...
        /// </summary>
        public event EventHandler<IWebIndexStorageSegment> DataOverwritten;

        /// <summary>
        /// Returns a segment if sored.
        /// </summary>
        /// <param name="addr">The address of th segment.</param>
        public IWebIndexStorageSegment this[ulong addr]
        {
        ...
        public WebIndexStorageRingBuffer(uint capacity)
        {
            buffer = new IWebIndexStorageSegment[capacity];
            dict = new Dictionary<ulong, IWebIndexStorageSegment>((int)capacity);
            head = 0;
            tail = 0;
        }
        ...
        public void Enqueue(IWebIndexStorageSegment item)
        {
        ...
        public IWebIndexStorageSegment Dequeue()
        {
            if (head == tail)
            {
                return null;
        ...
        protected virtual void OnDataOverwritten(IWebIndexStorageSegment e)
        {
