...
namespace WebExpress.WebIndex.Storage
{
    ...
    /// </summary>
    public class WebIndexStorageSegmentStatistic : WebIndexStorageSegment
    {
        /// <summary>
        ...
        public WebIndexStorageSegmentStatistic(WebIndexStorageContext context)
            : base(context)
        {
        }
        ...
        internal void AddCollision<T>(T item, uint collisions) where T : IWebIndexStorageSegmentListItem
        {
            if (item is WebIndexStorageSegmentTerm term)
            {
            ...
            else if (item is WebIndexStorageSegmentPosting posting)
            {
