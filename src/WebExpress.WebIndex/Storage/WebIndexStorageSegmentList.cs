...
namespace WebExpress.WebIndex.Storage
{
    ...
    public class WebIndexStorageSegmentList<T> : WebIndexStorageSegment, IEnumerable<T>
        where T : IWebIndexStorageSegmentListItem
    {
        ...
        public WebIndexStorageSegmentList(WebIndexStorageContext context)
            : base(context)
        {
        ...
        /// <param name="context">The reference to the context of the index.</param>
        /// <param name="sortDirection">The sort order of the list.</param>
        public WebIndexStorageSegmentList(WebIndexStorageContext context, ListSortDirection sortDirection)
            : base(context)
        {
