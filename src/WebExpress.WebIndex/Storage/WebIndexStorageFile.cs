...
{
    public class WebIndexStorageFile : IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        private WebIndexStorageRingBuffer Buffer { get; } = new WebIndexStorageRingBuffer(10000);

        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="fileName">The file name.</param>
        public WebIndexStorageFile(string fileName)
        {
            FileName = fileName;
        ...
        public T Read<T>(ulong addr, WebIndexStorageContext context) where T : IWebIndexStorageSegment
        {
        ...
        public T Read<T>(T segment) where T : IWebIndexStorageSegment
        {
        ...
        /// </summary>
        /// <param name="segment">The segment.</param>
        public void Write(IWebIndexStorageSegment segment)
        {
