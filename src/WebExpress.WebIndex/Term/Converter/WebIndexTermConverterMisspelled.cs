...
namespace WebExpress.WebIndex.Term.Converter
{
    ...
    /// </summary>
    public static class WebIndexTermConverterMisspelled
    {
        /// <summary>
        ...
        private static void FillMisspelledWordDictionary(IWebIndexContext context, CultureInfo culture)
        {
        ...
        public static IEnumerable<WebIndexTermToken> Misspelled(this IEnumerable<WebIndexTermToken> input, CultureInfo culture)
        {
